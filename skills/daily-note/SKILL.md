...
4. If it does not exist, create it with YAML frontmatter containing `tags: [daily]` and `date: YYYY-MM-DD`, followed by three sections: `## What happened`, `## Decisions`, `## Open threads`.
